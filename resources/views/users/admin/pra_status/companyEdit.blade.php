                ...
                <form action="{{route('serviceStore')}}" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" placeholder="Ex: Domain Service or Hosting Service or SSL Service">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select type="text" name="form_generator_id" id="form_generator_id" class="form-control">
                                ...
                                @foreach($forms as $form)
                                    <option value="{{$form->id}}">{{$form->name . "-" . $form->uuid}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="card-footer">
                        <div class="form-group clearfix mb-0">
                            <button type="submit" class="btn btn-primary float-right">Edit Service</button>
                        </div>
                    </div>
                </form>
            </div>
