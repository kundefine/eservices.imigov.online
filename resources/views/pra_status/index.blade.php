    ...
    <div id="boxmain">
        ...
        <div id="box_contentPublic">
            ...
            <div class="form_container">
                <form method="post" action="https://eservices.imi.gov.my/myimms/PRAStatus" id="PRAStatus">
                        ...
                        <table class="tblwidth" align="center" border="0" bgcolor="#F4F4FF">
                                ...
                                <td colspan="5" bgcolor="#FFFF00">
                                    <table border="0" style="font-weight: bold;">
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td>-</td>
                                            <td>Permohonan telah diterima.</td>
                                        </tr>
                                        <tr valign="top">
                                            <td>BARU</td>
                                            <td>-</td>
                                            <td>Permohonan telah diterima dan sedang diproses oleh Jabatan Imigresen
                                                Malaysia. Sila kirimkan salinan asal dari dokumen-dokumen sokongan
                                                sekiranya belum berbuat demikian.
                                            </td>
                                        </tr>
                                        <tr valign="top">
                                            <td>LULUS</td>
                                            <td>-</td>
                                            <td>Permohonan telah diluluskan oleh Jabatan Imigresen Malaysia dan bersedia
                                                untuk Pembayaran dan cetakan Pelekat. Sila buat pemeriksaan FOMEMA
                                                sekiranya belum berbuat demikian.
                                            </td>
                                        </tr>
                                        <tr valign="top">
                                            <td>TOLAK</td>
                                            <td>-</td>
                                            <td>Permohonan telah ditolak oleh Jabatan Imigresen Malaysia.</td>
                                        </tr>
                                        <tr>
                                            <td>BATAL</td>
                                            <td>-</td>
                                            <td>Permohonan telah dibatalkan oleh Jabatan Imigresen Malaysia.</td>
                                        </tr>
                                        <tr valign="top">
                                            <td>BAYAR</td>
                                            <td>-</td>
                                            <td>Permohonan telah dibayar dan bersedia untuk Cetakan Pelekat.</td>
                                        </tr>
                                        <tr valign="top">
                                            <td>CETAK</td>
                                            <td>-</td>
                                            <td>Pelekat telah di cetak dan sedia untuk dipungut.</td>
                                        </tr>
                                        <tr valign="top">
                                            <td>TANGGUH</td>
                                            <td>-</td>
                                            <td>Permohonan telah ditangguh oleh Jabatan Imigresen Malaysia.</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input name="MAD_ROC_NO1" type="text" id="MAD_ROC_NO1" value="" size="35"
                                           maxlength="20" style="text-transform: uppercase"><BR>( Contoh Format :
                                    999999-99-9999 )
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <div id="VIEW_IMG" style="position: absolute; cursor: hand;"><img
                                            src="{{asset('images/search_icon.png')}}" border="0" alt="Lihat Contoh">Lihat Contoh
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td colspan="5">
                                    <input type="submit" name="searchStatusPRA" id="searchStatusPRA" value="Carian"
