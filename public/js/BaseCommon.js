...
function populateResultUploadPspt(imagePath, imageValName, objId, imageId, gambaId, ICAOstr, ICAOnew){    
    document.getElementById(objId).src = imageValName;//imagePath;
    document.getElementById(imageId).value = imageValName;
    document.getElementById(gambaId).disabled = false;
    
    document.getElementById("allICAOresult").value = ICAOstr;
    document.getElementById("newICAOresult").value = ICAOnew;
}
